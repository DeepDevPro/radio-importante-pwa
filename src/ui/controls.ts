      ...
      <div class="info-modal" id="infoModal" style="display: none;">
        <div class="modal-content">
          <div class="modal-body">
            <p class="modal-description">Você está ouvindo a rádio do The Ern.<br />Aqui você vai escutar a essência do nosso espaço.<br />Acreditamos que a música é ponto fundamental de qualquer experiência, assim como o café, o vinho e a comida.<br />Sinta-se no nosso ambiente.</p>
