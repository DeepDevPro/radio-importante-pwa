...
// scripts/generate-audio-remote.js (server-local copy)
...
const ENV = {
  ...
  SPACES_BUCKET: process.env.SPACES_BUCKET || process.env.DO_SPACES_BUCKET || 'radio-importante-audio',
  ...
  SPACES_ENDPOINT: process.env.SPACES_ENDPOINT || (process.env.DO_SPACES_ENDPOINT ? `https://${process.env.DO_SPACES_ENDPOINT}` : 'https://atl1.digitaloceanspaces.com'),
  SPACES_REGION: process.env.SPACES_REGION || process.env.DO_SPACES_REGION || 'atl1',
  SPACES_KEY: process.env.SPACES_KEY || process.env.DO_SPACES_KEY || '',
  SPACES_SECRET: process.env.SPACES_SECRET || process.env.DO_SPACES_SECRET || '',
...
async function main() {
  ...
  // deps
  checkBin('ffmpeg', 'Instale com: apt-get install -y ffmpeg (ou bundle no container)');
  checkBin('ffprobe', 'Instale com: apt-get install -y ffmpeg');
